...
public class Main{
    public static void main(String[] args) {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            System.out.println("Mean: " + calculateMean(regionValues));
            System.out.println("Median: " + calculateMedian(regionValues));
            System.out.println("Mode: " + calculateMode(regionValues)+"\n");
        }
